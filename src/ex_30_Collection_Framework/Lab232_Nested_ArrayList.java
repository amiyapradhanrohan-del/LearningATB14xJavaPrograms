...
public class Lab232_Nested_ArrayList {
    public static void main(String[] args) {
        List<String> fruits1 = new ArrayList(); //Here the data type is string so string value will be printed
        fruits1.add("orange");
        fruits1.add("apple");
        fruits1.add("cherry");
//        fruits1.add(133);
...
//[mango, grapes, papaya]
//[tamato, patato, onion]
//[[orange, apple, cherry], [mango, grapes, papaya], [tamato, patato, onion]]
//3
//[mango, grapes, papaya]
