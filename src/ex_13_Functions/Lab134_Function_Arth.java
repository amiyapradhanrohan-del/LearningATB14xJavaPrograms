...
public class Lab134_Function_Arth {
    public static void main(String[] args) {
        ...
        // function -> type 4th - with return and with argument/ parameters
    ...
    static int readInt(Scanner scanner, String prompt){//Type 4 function
        System.out.println(prompt);
        if(scanner.hasNextInt()){
            return scanner.nextInt();
        }else{
            System.out.println("Enter the int only");
            System.exit(0); //if user will not enter integer value then we will exit from the code.
            return 0;
        }
    }
